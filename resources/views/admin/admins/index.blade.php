                        ...
                        <tbody>
                            ...
                            @foreach ($admins as $admin)
                                <tr>
                                    ...
                                    @if (auth()->user()->can('articles-read'))
                                        <td><a
                                                href="{{ route('admin.articles.index', ['user_id' => $admin->id]) }}">{{ $admin->user->articles_count ?? null }}</a>
                                        </td>
                                    @endif
                                    @if (auth()->user()->can('contacts-read'))
                                        <td><a
                                                href="{{ route('admin.contacts.index', ['user_id' => $admin->id]) }}">{{ $admin->user->contacts_count ?? null }}</a>
                                        </td>
                                    @endif
                                    @if (auth()->user()->can('traffics-read'))
                                        <td><a
                                                href="{{ route('admin.traffics.logs', ['user_id' => $admin->id]) }}">{{ $admin->user->logs_count ?? null }}</a>
                                        </td>
                                    @endif
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
                                                ...
                                                @can('admins-update')
                                                    <li><a class="dropdown-item font-1"
                                                            href="{{ route('admin.admins.edit', $admin) }}"><span
