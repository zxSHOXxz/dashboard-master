...
@section('content')
    ...
    <x-bread-crumb :breads="[
        ...
        ['url' => '#' , 'title' =>  $admin->user->name, 'isactive' => true],
    ]">
    </x-bread-crumb>
</div> --}}
    <div class="col-12 py-5 rounded-2" style="text-align: center;background: var(--background-1);margin-top: -5px;">
        <div class="col-12" style="display:flex;justify-content: center;">
            <img src="{{ $admin->user->getUserAvatar() }}" style="width:130px;height: 130px;border-radius: 50%;">
        </div>
                ...
                <div class="col-12 p-0 row justify-content-center">
                    <div class="col-12 row p-0">
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3  px-2 mb-3">
                            <a href="{{ route('admin.articles.index', ['user_id' => $admin->id]) }}" style="color:inherit;">
                                <div class="col-12 px-0 py-2 d-flex rounded-3 main-box-wedit" style="background: #ffffff;">
                                    ...
                                    <div style="width: calc(100% - 80px)" class="px-2 py-2">
                                        ...
                                        <h6 class="font-3">{{ $admin->user->articles->count() }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3  px-2 mb-3">
                            <a href="{{ route('admin.traffics.index', ['user_id' => $admin->id]) }}" style="color:inherit;">
                                <div class="col-12 px-0 py-2 d-flex rounded-3 main-box-wedit" style="background: #ffffff;">
                                    <div style="width: 80px;" class="p-2">
                                        <div class="col-12 px-0 text-center d-flex align-items-center justify-content-center"
                                            style="background-image: linear-gradient(rgba(0,0,0,.04),rgba(0,0,0,.04))!important;height: 64px;border-radius: 50%;">
                                    ...
                                    <div style="width: calc(100% - 80px)" class="px-2 py-2">
                                        ...
                                        <h6 class="font-3">{{ $admin->user->traffics->count() }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3  px-2 mb-3">
                            <a href="{{ route('admin.traffics.error-reports', ['user_id' => $admin->id]) }}"
                                style="color:inherit;">
                                <div class="col-12 px-0 py-2 d-flex rounded-3 main-box-wedit" style="background: #ffffff;">
                                    <div style="width: 80px;" class="p-2">
                                        <div class="col-12 px-0 text-center d-flex align-items-center justify-content-center"
                                    ...
                                    <div style="width: calc(100% - 80px)" class="px-2 py-2">
                                        ...
                                        <h6 class="font-3">{{ $admin->user->report_errors->count() }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 col-xl-3  px-2 mb-3">
                            <a href="{{ route('admin.contacts.index', ['user_id' => $admin->id]) }}"
                                style="color:inherit;">
                                <div class="col-12 px-0 py-2 d-flex rounded-3 main-box-wedit" style="background: #ffffff;">
                                    <div style="width: 80px;" class="p-2">
                                        <div class="col-12 px-0 text-center d-flex align-items-center justify-content-center"
                                    ...
                                    <div style="width: calc(100% - 80px)" class="px-2 py-2">
                                        ...
                                        <h6 class="font-3">{{ $admin->user->contacts->count() }}</h6>
                                    </div>
                                </div>
                            </a>
                        </div>
