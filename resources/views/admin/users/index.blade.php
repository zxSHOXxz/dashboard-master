                        ...
                        <tbody>
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    @if (auth()->user()->can('articles-read'))
                                        <td><a
                                                href="{{ route('admin.articles.index', ['user_id' => $user->id]) }}">{{ $user->articles_count ?? null }}</a>
                                        </td>
                                    @endif
                                    @if (auth()->user()->can('contacts-read'))
                                        <td><a
                                    ...
                                    @if (auth()->user()->can('comments-read'))
                                        <td><a
                                                href="{{ route('admin.article-comments.index', ['user_id' => $user->id]) }}">{{ $user->comments_count ?? null }}</a>
                                        </td>
                                    @endif
                                    @if (auth()->user()->can('traffics-read'))
                                        <td><a
